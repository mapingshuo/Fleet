...
# download train_data
mkdir data
wget https://paddlerec.bj.bcebos.com/word2vec/1-billion-word-language-modeling-benchmark-r13output.tar --no-check-certificate
...
# download test data
wget https://paddlerec.bj.bcebos.com/word2vec/test_dir.tar --no-check-certificate
