...
class word2vec(FleetDistRunnerBase):
    ...
    def net(self, inputs, params):
        ...
        neg_emb_b_vec = fluid.layers.reshape(
            neg_emb_b, shape=[-1, params.neg_num])
    ...
    def infer_net(self, params):
        with fluid.unique_name.guard():
            ...
            analogy_a = fluid.layers.data(
                name="analogy_a", shape=[1], dtype='int64')
            analogy_b = fluid.layers.data(
                name="analogy_b", shape=[1], dtype='int64')
            analogy_c = fluid.layers.data(
                name="analogy_c", shape=[1], dtype='int64')
            ...
            emb_all_label_l2 = fluid.layers.l2_normalize(
